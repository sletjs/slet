...
app.router(require('./fixtures/pathctrl') )  

test.cb('GET　http://127.0.0.1:4002/path/a?a=１', t => {
  axios.get('http://127.0.0.1:4002/path/a?a=1')
...
test.cb('GET http://127.0.0.1:4002/path/a?a=2', t => {
  axios.get('http://127.0.0.1:4002/path/a?a=2')
  .then(function (response) {
